...
const schemas = toJsonSchemaDefs(
	{
		...
		ConnectedSource: connectedSourceSchema,
		Series: seriesSchema,
		DomainVitals: domainVitalsSchema,
		DomainDependencies: domainDependenciesSchema,
		ServiceVitals: serviceVitalsSchema,
		ServiceMetrics: serviceMetricsSchema,
		SloBudget: sloBudgetSchema,
		DomainDeploymentStats: domainDeploymentStatsSchema,
		ServiceSloRow: serviceSloRowSchema,
		MetricInsight: metricInsightSchema,
		Region: regionSchema,
		NodeCounts: nodeCountsSchema,
		Cluster: clusterSchema,
		ResourceUsage: resourceUsageSchema,
		Storage: storageSchema,
		Database: databaseSchema,
		Queue: queueSchema,
		InfraAlert: infraAlertSchema,
		Cost: costSchema,
		Error: errorSchema,
...
const parameters = {
	...
	DomainSlug: {
		...
		description:
			'The domain identifier, as returned by the domains collection. Static sub-paths such as `summary` take precedence, so a domain may not be identified by one of those words.'
	},
	ServiceSlug: {
		name: 'slug',
		in: 'path',
